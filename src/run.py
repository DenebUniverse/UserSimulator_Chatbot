...
from deep_dialog.agents import InformAgent, RequestAllAgent, RandomAgent, EchoAgent, RequestBasicsAgent, \
    AgentDQN
...
if __name__ == "__main__":
    ...
    parser.add_argument('--simulation_epoch_size', dest='simulation_epoch_size', type=int, default=500,
...
def run_episodes(count, status):
    ...
    for episode in range(count):
        ...
        if agt == 9 and params['trained_model_path'] == None:
            ...
            if episode % save_check_point == 0 and params['trained_model_path'] is None:
